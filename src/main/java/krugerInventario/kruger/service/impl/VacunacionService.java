...
import krugerInventario.kruger.service.VacunacionInterface;
import krugerInventario.kruger.util.Validar;
import lombok.extern.log4j.Log4j2;

@Log4j2
@Service
public class VacunacionService implements VacunacionInterface {
    @Autowired
    VacunacionDAO vacunaDAO;
     ...
     */
    @Override
    public ResponseEntity<Response> guardarVacunacion(Vacunacion request) {
    ...
    public ResponseEntity<Response> listarVacunacion() {
        Response resp = new Response();
        try {
            List<Vacunacion> listVacuna = vacunaDAO.findAll();
